...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Wide shot of a long pale carpeted dormitory hallway in a 1990s California mansion at dusk, two parallel rows of identical metal-frame bunks with neatly folded purple cloth on each pillow, identical matching black tracksuits hanging on hooks beside each bunk, a single matching black sneaker placed at the foot of one bunk, the other shoe not visible, pale-carpet beige + folded-purple-cloth + matching-black-tracksuit palette, soft warm window-light at the end of the hall as the named light, observational documentary realism, ultra-detailed, photoreal micro-texture, tack-sharp focal subject, crisp edge contrast, 8K render quality, no AI-blur, no plastic skin, no waxy highlights, no soft background haze.",
      "motion_prompt": "camera slow push-in, the unworn second sneaker stays motionless, dusk light shifts a degree across the carpet",
  ...
  "full_script": "What does it cost to believe a spacecraft is waiting behind a comet? On March 26th, 1997, in a rented mansion in Rancho Santa Fe, thirty-nine people lay down for the last time. They were dressed identically in black. They had folded their belongings. They had recorded farewell tapes. They believed they were not dying. They believed they were leaving. The group had begun in the 1970s. Two leaders. A doctrine of leaving the human shell behind. Decades of recruiting through bookstores and lectures. The members had jobs. They had college degrees. Some had spouses. Many had walked into the group sincerely searching, not desperate. When the comet Hale-Bopp arrived, the leaders said the time had come. Everyone knows the bodies were found. What nobody talks about is what they had been doing the week before. Building a website. They were software engineers. The website is still online. It is still recruiting. It will outlive most of the people reading this. The recruiter was always the doctrine. The bodies were a footnote.",
