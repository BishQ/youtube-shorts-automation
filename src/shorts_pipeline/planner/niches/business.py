...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Low-angle hero shot of an unbranded modern Nordic glass headquarters at dusk, top-floor signage area intentionally dark and unreadable, a black sedan pulling up at the entrance, a single executive in a charcoal coat mid-stride toward the revolving door, briefcase in his right hand, a barely-visible candy-bar handset in his coat pocket, Wall Street navy and Helsinki ice-white, helicopter spotlight catching the upper floors, epic blockbuster cinema, IMAX frame.",
  ...
  "full_script": "How does the world's biggest phone company disappear in five years? They had 40% of the market the day the iPhone launched. In a glass tower in Espoo, engineers had already built a touchscreen. Management shelved it. Their best-selling model still had buttons. Customers loved the buttons. Markets reward what worked yesterday, until they don't. The engineers who built the prototype quit. Some walked into rooms in Cupertino. Everyone knew Nokia made phones. What nobody said was that Nokia made one mistake — they thought hardware was the product. By the time they understood software, the software was an ecosystem. The ecosystem was not theirs. They sold the handset division for the price of a Silicon Valley office. The brand survived. The company that built it did not. The most-used phone in history was killed by the company that built it.",
