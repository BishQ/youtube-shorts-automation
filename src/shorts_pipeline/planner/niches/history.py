"""Niche: History, Civilizations & Lore.

Scope: documented historical events, figures, turning points, and material
culture from any era for which primary or scholarly sources exist —
antiquity, medieval, early modern, industrial, twentieth century, and the
recent past (handled with living-figure restraint). Treated as DOCUMENTARY:
...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Low-angle wide of a high-vaulted council chamber in Prague Castle, three imperial regents in mid-rise from a heavy oak bench, twenty-odd Bohemian noblemen in mid-stride toward them in slashed black-and-cream doublets and starched ruffs, leaded-glass window mid-frame, candles in iron sconces along stone walls, oil-paper-pale dawn through clerestory, tallow-amber + stone-grey + slashed-doublet-cream palette, candles in iron sconces as the named light, observational 17th-century documentary realism, ultra-detailed, photoreal micro-texture, tack-sharp focal subject, crisp edge contrast, 8K render quality, no AI-blur, no plastic skin, no waxy highlights, no soft background haze.",
      "motion_prompt": "camera slow push-in, the seated regents rise one inch from the bench, candle smoke drifts past the leaded-glass pane",
  ...
  "full_script": "Why did three men survive a fall from a castle window — and what did Europe pay for it? On the morning of 23 May 1618, the trial was already lost before anyone spoke. The Bohemian nobles had brought a written accusation. The regents had brought no defence. The chamber was cold. The windows were closed. Then the windows were opened. Two regents and their secretary went out — sixty-nine feet to the ground. All three survived the impact. The Catholic chroniclers said angels intervened. The Protestants said the dung-heap below caught them. Everyone knows the war that followed lasted thirty years. What nobody talks about is that on that morning, nobody in the chamber expected a war at all. They expected a precedent. The precedent travelled across the continent within a week. By autumn the kingdom had a new king. By spring four armies were marching. Eight million people would perish before the treaty in 1648 named the religion of every village in central Europe. The window in Prague still opens. The latch is original. The dung-heap is gone.",
