...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Extreme wide shot looking out across a vast cosmic void of deep-indigo black, a single distant galaxy a small pinprick of warm white near one edge of the frame, no other stars or structures in the empty middle of the frame, dust-violet faint background, single distant-galaxy light as the named source, deep-indigo + dust-violet + single-pinprick-warm-white palette, observational cosmic-scale realism, ultra-detailed, photoreal micro-texture, tack-sharp focal subject, crisp edge contrast, 8K render quality, no AI-blur, no plastic skin, no waxy highlights, no soft background haze.",
      "motion_prompt": "camera slow pull-back, the pinprick galaxy dims a fraction, indigo dust drifts faintly across the void",
