...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Low-angle hero shot of a Stockholm 19th-century private-banking office at dusk, mahogany panelling and green-leather chairs, a tall thin man in his thirties in a charcoal frock coat standing at a partner desk, mid-glance toward a brass nameplate on the door, a green-shaded desk lamp casting a single pool of light, a folded share-certificate ledger on the desk, painterly realism, deep shadow contrast.",
  ...
  "full_script": "How does one Swedish family quietly own a third of its country's stock market? In a Stockholm office in 1856, a thirty-year-old former naval officer opened a bank. He had no inheritance. He had a wife from a banking family. He had a system. His sons followed him. So did their sons. In 1916, the family put its shares into a foundation. The foundation's mission was to outlive them. The family controlled the foundation. The foundation controlled the shares. The shares controlled Sweden's largest companies. Telecoms. Pharmaceuticals. Trucks. Banks. Everyone in Sweden knows their products. What nobody talks about is who decides what those companies do. The current patriarch is the fifth generation. He gives almost no interviews. His decisions move companies that employ a million people. The country has a private head of industry it did not elect. Most of its citizens cannot name him.",
