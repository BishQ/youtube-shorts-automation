...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Low-angle hero shot of a two-masted merchant brigantine drifting on a flat Atlantic at dawn, sails partly furled and partly torn flapping in low wind, the wheel turning untouched in the foreground, deep ocean indigo and slate, deep ocean indigo and slate palette, pale dawn through scattered cloud as the named light, salt mist clinging to the deck, observational forensic realism, ultra-detailed, photoreal micro-texture, tack-sharp focal subject, crisp edge contrast, 8K render quality, no AI-blur, no plastic skin, no waxy highlights, no soft background haze.",
      "motion_prompt": "camera slow push-in, the abandoned wheel turns one quarter-spin, torn sail edges ripple in low dawn wind",
  ...
  "full_script": "What makes a captain abandon a working ship in the middle of the ocean? On the morning of December 5th, 1872, a British brigantine found one. Her name was the Mary Celeste. Sails set. Wheel turning free. Hatches open to the weather. The cargo hold held fifteen hundred barrels of industrial alcohol. None of them appeared missing. The captain's logbook was up to date through the previous morning. The table in the cabin was set for breakfast. The chronometer and the sextant were gone. So was the lifeboat. So was the captain's young wife. So was the two-year-old child. Everyone knows the ship was found. What nobody talks about is what exactly was missing — the precise things a crew would take if they believed they were going to die. They lowered a boat into a calm sea, towed behind by a single rope, and that rope was apparently severed. They never came back. Ten people gone. No bodies recovered. No wreckage. No witnesses. Salvage took the ship to Gibraltar. The hearing concluded what the evidence allowed. The crew were last seen by no one.",
