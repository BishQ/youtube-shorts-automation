...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Low-angle hero shot of the Big Ear radio telescope at night, a vast tilted aluminium reflector field against a deep cosmic-indigo sky, the Milky Way arching overhead in starfield white, a small lit control hut at the base with one window glowing red, a single astronomer in a brown corduroy jacket mid-stride toward the door holding a printout, cosmic-indigo sky + aluminium-reflector grey + observatory-red-window palette, observatory red-light through the hut window as the named source, observational radio-astronomy realism, ultra-detailed, photoreal micro-texture, tack-sharp focal subject, crisp edge contrast, 8K render quality, no AI-blur, no plastic skin, no waxy highlights, no soft background haze.",
      "motion_prompt": "camera slow push-in, the astronomer's printout lifts a fraction in his hand, the Milky Way wheels slowly overhead",
  ...
  "full_script": "What does it actually sound like when something out there finally answers a question? Seventy-two seconds in August 1977. Ohio. A radio telescope swept a single patch of sky in the constellation Sagittarius. The data came out on continuous-feed printer paper rolls. Three days later, an astronomer flipped a page and stopped completely. The signal was thirty times stronger than the background radiation. Narrow band. The exact frequency that hydrogen atoms broadcast at — the one we had agreed any extraterrestrial civilisation would broadcast on. He wrote a single word in the margin. Wow. Everyone knows about the signal itself today. What nobody talks about is what came afterward at the observatory. They re-pointed the same telescope at the exact same patch the very next night. They pointed it the night after. They pointed it for over forty additional years. The sky has not made that sound again. We listened for seventy-two seconds total. Whatever was speaking on that frequency has not spoken since.",
