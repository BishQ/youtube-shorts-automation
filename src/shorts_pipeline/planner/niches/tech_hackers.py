...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Medium close-up of a thin young man in his early twenties in a grey university sweatshirt sitting at a wood-grain CRT terminal in a darkened Cornell computer lab at 2am, mid-pause as he reaches forward to press the return key, his face lit only by monitor-amber CRT glow, a half-eaten plate of pizza pushed aside, banks of beige terminals stretching out behind him, amber-CRT + beige-terminal-plastic + pizza-grease-cardboard palette, monitor-amber CRT glow as the named light, late-1980s observational hacker-lab realism, ultra-detailed, photoreal micro-texture, tack-sharp focal subject, crisp edge contrast, 8K render quality, no AI-blur, no plastic skin, no waxy highlights, no soft background haze.",
      "motion_prompt": "camera slow push-in, his index finger hovers a centimetre above the return key, amber CRT flicker shifts across his face",
  ...
  "full_script": "How does one graduate student take the internet offline by accident? At Cornell University in November 1988, a 23-year-old wrote a small program to count machines. The program was supposed to copy itself across every host it could reach and report back. It was supposed to copy itself ONCE per host. He had added a feature to make absolutely sure of that. Then he had worried the feature would be too easy to evade. So he made it copy a second time, randomly. The random number was wrong. The program copied itself again. And again. And again. On every machine. Within four hours, six thousand computers were completely unusable. The first internet outage in history was not malicious. It was a young engineer adding one safety net too many. Everyone knows the story of the Morris Worm. What nobody talks about is what happened afterward. Its author was the first person ever convicted under the Computer Fraud and Abuse Act. He grew up to become a professor of computer science at MIT.",
