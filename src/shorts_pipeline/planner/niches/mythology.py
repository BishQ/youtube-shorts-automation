...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Low-angle hero shot of a tall lean figure in his late thirties in a torn dark-grey tunic and silver-clasped cloak, mid-glare across a long-fire hall, antler rafters above and a hearth fire central, twelve robed gods seated around the hall in mid-rise from their benches, the figure's mouth mid-word, his eyes lit with the long-fire glow, hearth-amber + soot-black-rafter + silver-clasp-glint palette, central long-fire hearth as the named light, mythic-tableau observational realism, ultra-detailed, photoreal micro-texture, tack-sharp focal subject, crisp edge contrast, 8K render quality, no AI-blur, no plastic skin, no waxy highlights, no soft background haze.",
      "motion_prompt": "camera slow push-in, his glare hardens by a fraction, hearth-flames throw long antler shadows across the rafters",
  ...
  "full_script": "What does it cost to outsmart the gods who once called you brother? In the Norse telling, Loki insulted them all at a great feast, and they did not forget what he said. He had walked among them since the very beginning of the world. He had lied for them. He had lied to them. The great hall fell completely quiet when he finally stood up. He named the hidden secret of every god in the room one by one. Then he ran for his life across the icy plains. They caught him eventually in a waterfall, in the shape of a leaping salmon. They took both of his beloved sons. They turned one into a wolf. They used the entrails of the other to bind him to three stones. They placed a venomous serpent above his face, and its poison dripped down for centuries. Everyone knows Loki was the trickster of the old myths. What nobody talks about is what was actually done to him at the end. He is bound there, in the telling, until the very last battle. When he shakes, in the myth, the earth shakes with him. The gods who bound him will fall in that battle. He will be among the ones who kill them.",
