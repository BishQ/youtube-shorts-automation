...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Medium close-up of a man in his early thirties in a beige wool jumper, sitting at a long wooden table, mid-glance toward a card held up by an unseen researcher, seven other men in white shirts seated around the table mid-turn toward him, the subject's jaw slightly tense, beige-wool + white-shirt + wood-table + closed-blind-shadow palette, single tungsten desk lamp from the right as the named light, 1950s observational laboratory realism, ultra-detailed, photoreal micro-texture, tack-sharp focal subject, crisp edge contrast, 8K render quality, no AI-blur, no plastic skin, no waxy highlights, no soft background haze.",
      "motion_prompt": "camera slow push-in, the subject's jaw tightens a millimetre, the seven other men hold their stillness in unison",
  ...
  "full_script": "Why do you stop trusting your own eyes when seven strangers disagree with them? In a small laboratory room in 1951, a man in a beige jumper looked at a card and answered wrong on purpose. Seven men around him had already given the exact same wrong answer aloud. He was the eighth. He could plainly see the right line in front of him. He gave the wrong one anyway. The researcher's name was Solomon Asch. The line he chose was visibly longer than the others. Everyone in the room knew it. Everyone said otherwise. Three quarters of his subjects conformed at least once during the trials. Everyone knows the result of the study. What nobody talks about is what the subjects actually said afterward in the interviews. Half of them insisted the line really had looked shorter to them. The eye did not lie. The brain rewrote what the eye actually saw, to match the room. The laboratory is closed now. The hallway is empty. The result is still in your meetings. In your group chats. In the version of yourself you only let out when you are completely alone.",
