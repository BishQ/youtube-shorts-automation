...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Low-angle hero shot of a Soviet duty officer in his early forties in a long olive duty coat, sitting forward in a steel-frame chair in the Serpukhov-15 command bunker, a wall of amber CRT screens behind him mid-flicker, one screen showing the letters mid-blink, a single red rotary telephone in the foreground, the officer's right hand mid-pause above the receiver, his face lit only by bunker-amber CRT glow, his jaw clenched, dark CCCP-style insignia on his shoulder, amber-CRT + Bakelite-black + steel-grey + red-rotary-phone palette, bunker-amber CRT glow as the named light, Cold-War situation-room observational realism, ultra-detailed, photoreal micro-texture, tack-sharp focal subject, crisp edge contrast, 8K render quality, no AI-blur, no plastic skin, no waxy highlights, no soft background haze.",
      "motion_prompt": "camera slow push-in, the officer's hand drifts an inch toward the red receiver, CRT screens flicker amber across his jaw",
