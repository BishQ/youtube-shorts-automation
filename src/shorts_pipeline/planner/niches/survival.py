...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Wide shot of dense Amazon jungle canopy seen from below at dawn, broken sunlight piercing in narrow shafts, a teenage girl in her late teens in a sleeveless white shift dress mid-stride along a tiny stream, one arm cradling a broken collarbone, hair tangled, a single pair of broken spectacles on her face, jungle-emerald + canopy-dapple + dawn-shaft-amber palette, jungle dapple from the canopy as the named light, observational survival-documentary realism, ultra-detailed, photoreal micro-texture, tack-sharp focal subject, crisp edge contrast, 8K render quality, no AI-blur, no plastic skin, no waxy highlights, no soft background haze.",
      "motion_prompt": "camera slow push-in, she takes one limping step forward, dawn shafts shift a degree across the damp leaves",
  ...
  "full_script": "How does a seventeen-year-old walk out of the Amazon after a plane falls out of the sky? On Christmas Eve, 1971, a Peruvian airliner flew into a thunderstorm at 21,000 feet. Lightning struck the right wing. The entire wing came off. The cabin split apart in the air. Ninety-one people died on impact. One did not. She woke up the next morning, still strapped to her aeroplane seat, on the rainforest floor. Her collarbone was broken. Her glasses were missing one lens. She knew exactly where she was. Her father was a working biologist. He had told her one sentence when she was six years old. Find a stream. Follow it downhill. Streams meet rivers. Rivers eventually meet people. She walked alone for eleven days through the jungle. She drank from the stream. She slept beside it. She fought infection in a thigh-wound full of fly larvae. On the eleventh day, she found a hunting hut. The hut had a working radio inside. Everyone remembers the survivor. What nobody talks about is how she actually survived: a single sentence from a father, twelve years before the night the wing came off.",
