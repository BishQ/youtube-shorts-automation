...
{{
  ...
  "full_script": "What does it cost to be one strike away from the World Series? October 12th, 1986. The Angels were ahead. Their closer was on the mound. Two outs. Bottom of the ninth. Three games to one in the series. He had been the team's closer for two years. His arm hurt every pitch. Everyone in the bullpen knew. The manager left him in. He threw a fastball. The Red Sox batter hit it over the left field fence. The Angels lost that game. They lost the series. Everyone remembers the home run. What nobody talks about is the next year. The fans wouldn't let go. Every introduction in every away city carried the same boo. He pitched two more seasons in pain. Then he stopped. Then, in 1989, he ended his own life. The crowd remembers the home run. The team-mates remember the man.",
