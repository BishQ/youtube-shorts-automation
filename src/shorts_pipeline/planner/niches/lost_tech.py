...
{{
  ...
  "clauses": [
    {{
      ...
      "image_prompt": "Extreme close-up macro of a single corroded green-bronze ancient gear with visible mesh teeth, the gear lying on black museum velvet, surface oxidation patterns visible, the largest tooth catching a single overhead warm pin-spot, the rest of the gear in shadow, deep museum-black + green-bronze patina + warm-pinspot-amber palette, single overhead pin-spot as the named light, observational museum-object realism, ultra-detailed, photoreal micro-texture, tack-sharp focal subject, crisp edge contrast, 8K render quality, no AI-blur, no plastic skin, no waxy highlights, no soft background haze.",
      "motion_prompt": "camera slow push-in, the warm highlight crawls across the largest gear tooth, dust motes drift in the pin-spot beam",
  ...
  "full_script": "Why was a hand-cranked computer at the bottom of the Aegean in the first century BCE? In 1901, sponge divers off the Greek island of Antikythera pulled a corroded block of bronze out of an ancient shipwreck. For fifty years, museum staff thought it was a navigational tool. In 1951 an X-ray showed gears. Thirty of them. Meshed precisely. Inside a wooden case roughly the size of a shoebox. When the gears were finally modelled, the device turned out to predict the position of the Sun, the Moon, the visible planets, the date of eclipses, and even the next Olympic Games. Everyone knows the mechanism was eventually discovered. What nobody talks about is what its mere existence means. The Greeks who built it left no manual. They left no surviving second copy. The technique to manufacture it disappears from the historical record. Clockwork at this complexity does not reappear anywhere for over a thousand years. The mechanism is not a mystery. It is a receipt. Proof that we have lost most of what humans once knew.",
