...
{{
  ...
  "full_script": "Why does every fire hydrant in the world have a five-sided nut? Look closer. Your wrench at home can't turn it. Pull a household spanner out of your toolbox. It has two jaws. Two parallel jaws grip flats. Flats come in even numbers — four, six, eight. A pentagon has five. Two jaws can never get a clean grip on five sides. Everyone thinks the colour matters. The colour tells the firefighter how much water comes out. The shape is the actual security. Fire crews carry a single special wrench — a pentagonal socket cut to fit. Nothing in a garage will. You can stand next to a hydrant with every tool in your house and not open it. The five-sided nut is the simplest anti-tampering device ever engineered. No lock. No alarm. Just geometry. The reason your city still has water pressure in a fire is a shape your wrench was never going to fit.",
