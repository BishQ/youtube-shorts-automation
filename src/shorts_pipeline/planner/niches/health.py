...
{{
  ...
  "full_script": "Why did it take doctors two hundred years to wash their hands? In Vienna in 1847, one in five mothers in the doctors' maternity ward died after delivery. In the midwives' ward, almost none did. The doctors examined autopsies in the morning. They examined live mothers in the afternoon. The midwives did not. A 28-year-old assistant noticed. His name was Ignaz Semmelweis. He instituted a single rule: chlorine wash between the morgue and the ward. Within a year, mortality fell below two percent. He had no theory of germs. He could not explain WHY. He only knew the soap worked. His colleagues called him an insult to their profession. They refused to wash. He grew angrier, then strange. In 1865 he was committed to an asylum. Two weeks later he was dead — of a wound infection, beaten by his attendants. The germ theory was published the year after. He had been right for eighteen years.",
